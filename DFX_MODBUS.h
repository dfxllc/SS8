...
public:
  ...
  void     withSlaveAddress(uint8_t u8SlaveAddress);

  uint8_t  readCoils(uint16_t u16ReadAddress, uint16_t u16BitQty);
  uint8_t  readCoils(uint8_t u8SlaveAddress, uint16_t u16ReadAddress, uint16_t u16BitQty);

  uint8_t  readDiscreteInputs(uint16_t u16ReadAddress, uint16_t u16BitQty);
  uint8_t  readDiscreteInputs(uint8_t u8SlaveAddress, uint16_t u16ReadAddress, uint16_t u16BitQty);

  uint8_t  readHoldingRegisters(uint16_t u16ReadAddress,  uint16_t u16ReadQty);
  uint8_t  readHoldingRegisters(uint8_t u8SlaveAddress, uint16_t u16ReadAddress,  uint16_t u16ReadQty);

  uint8_t  readInputRegisters(uint16_t u16ReadAddress,  uint8_t u16ReadQty);
  uint8_t  readInputRegisters(uint8_t u8SlaveAddress, uint16_t u16ReadAddress,  uint8_t u16ReadQty);

  uint8_t  writeSingleCoil(uint16_t u16WriteAddress, uint8_t u8State);
  uint8_t  writeSingleCoil(uint8_t u8SlaveAddress, uint16_t u16WriteAddress, uint8_t u8State);

  uint8_t  writeSingleRegister(uint16_t u16WriteAddress,  uint16_t u16WriteValue);
  uint8_t  writeSingleRegister(uint8_t u8SlaveAddress, uint16_t u16WriteAddress,  uint16_t u16WriteValue);

  uint8_t  writeMultipleCoils(uint16_t u16WriteAddress,  uint16_t u16BitQty);
  uint8_t  writeMultipleCoils(uint8_t u8SlaveAddress, uint16_t u16WriteAddress,  uint16_t u16BitQty);

  uint8_t  writeMultipleCoils();
  uint8_t  writeMultipleCoils(uint8_t u8SlaveAddress);

  uint8_t  writeMultipleRegisters(uint16_t u16WriteAddress,  uint16_t u16WriteQty);
  uint8_t  writeMultipleRegisters(uint8_t u8SlaveAddress, uint16_t u16WriteAddress,  uint16_t u16WriteQty);

  uint8_t  writeMultipleRegisters();
  uint8_t  writeMultipleRegisters(uint8_t u8SlaveAddress);

  uint8_t  maskWriteRegister(uint16_t u16WriteAddress, uint16_t u16AndMask, uint16_t u16OrMask);
  uint8_t  maskWriteRegister(uint8_t u8SlaveAddress, uint16_t u16WriteAddress, uint16_t u16AndMask, uint16_t u16OrMask);
  ...
  uint8_t  readWriteMultipleRegisters(uint8_t u8SlaveAddress,
                                      uint16_t u16ReadAddress, uint16_t u16ReadQty,
                                      uint16_t u16WriteAddress,uint16_t u16WriteQty);

  uint8_t  readWriteMultipleRegisters(uint16_t u16ReadAddress, uint16_t u16ReadQty);
  uint8_t  readWriteMultipleRegisters(uint8_t u8SlaveAddress, uint16_t u16ReadAddress, uint16_t u16ReadQty);
